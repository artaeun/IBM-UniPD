...
- Le funzioni che vengono già "installate" in python si chiamano _primitive_.
...
>>> 5
```
_a_, _b_ nell'esempio sopra sono _parametri_, cioè variabili che usiamo nell'esecuzione della funzione. 
...
- Organizzare il codice del programma in una serie di chiamate a funzioni che catturano la logica più che i dettagli implementativi.
