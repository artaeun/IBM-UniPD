...
- **Leibniz** ideò il **sistema numerico binario**.
...
- **Ada Augusta Byron** fu la prima programmatrice della storia. Il linguaggio Ada (1979) è nominato così in suo onore. Ella scrisse una sequenza di istruzioni (programma) per la macchina di Babbage, con le quali si calcolavano i numeri di Bernoulli.

- La **macchina a schede perforate**, dello statunitense Hermann **Hollerith**, fu la prima ad usare l'elettricità (1890).