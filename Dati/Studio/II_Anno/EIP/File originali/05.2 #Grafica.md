...
>>> win = GraphicsWindow()
```
La nuova finestra verrà automaticamente visualizzata sullo schermo. Contiene un pannello (detto canvas) largo 400 pixel e alto 400 pixel (default)
...
Il comando _win.wait()_ serve per evitare la terminazione immediata della finestra grafica.
